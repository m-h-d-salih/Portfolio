export default function AboutMe() {
    return (
        <section className="min-h-screen bg-[#222324] text-white pt-16 px-4 md:px-8 lg:px-20 mt-2">
      {/* <div className=" p-6 sm:p-8 rounded-lg shadow-2xl max-w-2xl mx-auto border border-gray-200 "> */}
        ...
        <p className="mb-6 text-[#9ca3af] leading-relaxed text-sm sm:text-base">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-24 mt-20 text-[#9ca3af]">
          ...
          <div>
            ...
            <a href="https://linkedin.com/in/alflyvazad" className="text-blue-500 hover:text-blue-600">linkedin.com/in/salih</a>
          </div>
          <div>
            <p className="font-semibold ">Github:</p>
            <a href="https://github.com/m-h-d-salih" className="text-blue-500 hover:text-blue-600">github.com/m-h-d-salih</a>
          </div>
        </div>
