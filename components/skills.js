...
export const skills = [
  ...
  { id: 3, name: 'ReactJS', img: '/assets/react.png', level: 92 },
  { id: 4, name: 'NodeJS', img: '/assets/nodejs.png', level: 88 },
  { id: 5, name: 'ExpressJS', img: '/assets/expressjs.png', level: 80 },
  { id: 6, name: 'TypeScript', img: '/assets/ts.png', level: 75 },
  { id: 7, name: 'Redux', img: '/assets/redux.png', level: 85 },
  { id: 8, name: 'HTML & CSS', img: '/assets/htmlcss.png', level: 95 },
  { id: 9, name: 'Tailwind CSS', img: '/assets/tailwind.png', level: 90 },
  { id: 10, name: 'Bootstrap', img: '/assets/bootstrap.png', level: 80 },
      ...
      <div className="flex gap-6 flex-wrap justify-center items-center lg:px-20 mt-10">
        {skills.map((skill) => (
          <div 
            ...
            className="flex flex-col items-center justify-center h-48 w-56 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl p-4"
          >
            {/* Skill Image */}
            <Image
              src={skill.img}
